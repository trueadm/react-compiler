(function() {
  ...
  function HeaderBar() {
    ...
    setStyle(td1, "padding-right", "4px");
    appendChild(tbody, td1);
    const a1 = createElement("a");
    setAttr(a1, "href", "#");
    appendChild(td1, a1);
    setAttr(a1, "href", "#");
    const img1 = createElement("img");
    setAttr(img1, "src", "logo.png");
    setAttr(img1, "width", "16");
    setAttr(img1, "height", "16");
    setStyle(img1, "border", "1px solid #00d8ff");
    const td2 = createElement("td");
    appendChild(tbody, td2);
    setStyle(td1, "line-height", "12pt");
    setAttr(td1, "height", 10);
    const span1 = createElement("span");
    span1.className = "pagetop";
    appendChild(td2, span1);
    const b = createElement("b");
    b.className = "hnname";
    b.textContent = "React HN Benchmark";
    appendChild(span1, b);
    const a2 = createElement("a");
    setAttr(a2, "href", "#");
    a2.textContent = "new";
    appendChild(span1, a2);
    const textNode1 = createTextNode(" | ")
    appendChild(span1, textNode1);
    const a3 = createElement("a");
    setAttr(a3, "href", "#");
    a3.textContent = "comments";
    appendChild(span1, a3);
    const textNode2 = createTextNode(" | ")
    appendChild(span1, textNode2);
    const a4 = createElement("a");
    setAttr(a4, "href", "#");
    a4.textContent = "show";
    appendChild(span1, a4);
    const textNode3 = createTextNode(" | ")
    appendChild(span1, textNode3);
    const a5 = createElement("a");
    setAttr(a5, "href", "#");
    a5.textContent = "ask";
    appendChild(span1, a5);
    const textNode4 = createTextNode(" | ")
    appendChild(span1, textNode4);
    const a6 = createElement("a");
    setAttr(a6, "href", "#");
    a6.textContent = "jobs";
    appendChild(span1, a6);
    const textNode5 = createTextNode(" | ")
    appendChild(span1, textNode5);
    const a7 = createElement("a");
    setAttr(a7, "href", "#");
    a7.textContent = "submit";
    appendChild(span1, a7);
    appendChild(a1, img1);
  ...
  function Story(story, rank) {
    ...
    tr1.className = "athing";
    frag.push(tr1);
    const td1 = createElement("td");
    setStyle(td1, "vertical-align", "top");
    setStyle(td1, "text-align", "right");
    td1.className = "title";
    const span1 = createElement("span");
    span1.className = "rank"
    span1.textContent = `${rank}.`;
    appendChild(td1, span1);
    appendChild(tr1, td1);
    const td2 = createElement("td");
    setStyle(td2, "vertical-align", "top");
    td2.className = "votelinks";
    const center1 = createElement("center");
    const a1 = createElement("a");
    setAttr(a1, "href", "#");
    const div1 = createElement("div");
    div1.className = "votearrow";
    setAttr(div1, "title", "upvote");
    appendChild(a1, div1);
    appendChild(center1, a1);
    appendChild(td2, center1);
    appendChild(tr1, td2);
    const td3 = createElement("td");
    td3.className = "title";
    const a2 = createElement("a");
    setAttr(a2, "href", "#");
    a2.className = "storylink";
    a2.textContent = story.title;
    appendChild(td3, a2);
    if (story.url) {
      const span2 = createElement("span");
      span2.className = "sitebit comhead";
      appendChild(td3, span2);
      const textNode1 = createTextNode(" ");
      appendChild(span2, textNode1);
      const textNode2 = createTextNode("(");
      appendChild(span2, textNode2);
      const a3 = createElement("a");
      setAttr(a3, "href", "#");
      a3.textContent = getHostUrl(story.url);
      appendChild(span2, a3);
      const textNode3 = createTextNode(")");
      appendChild(span2, textNode3);
    }
    appendChild(tr1, td3);
  ...
  function StoryList(stories) {
    ...
    setAttr(table, "cellPadding", 0);
    setAttr(table, "cellSpacing", 0);
    setAttr(table, "classList", "itemlist");
    for (let i = 0, length = stories.length; i < length; i++) {
      const story = Story(stories[i], i + 1);
      appendChild(table, story);
    }
  ...
  function Component({ stories }) {
    ...
    setAttr(table, "cellPadding", 0);
    setAttr(table, "cellSpacing", 0);
    setAttr(table, "width", "85%");
    setStyle(table, "background-color", "#f6f6ef");
    const tbody = createElement("tbody");
    const headerBar = HeaderBar();
    appendChild(tbody, headerBar);
    const tr = createElement("tr");
    setAttr(tr, "height", 10)
    const storyList = StoryList(stories);
    appendChild(tbody, headerBar);
    appendChild(tbody, tr);
    appendChild(tbody, storyList);
    appendChild(table, tbody);
    appendChild(center, table);
    return center;
  }
