...
, "UFI2ReactionsCount__sentence foo UFI2ReactionsCount__sentenceWithSocialContext", 42 // STATIC_PROP
, "data-testid", "UFI2ReactionsCount/sentenceWithSocialContext", 8 // CLOSE_ELEMENT
];
var __hoisted__opcodes__5 = [4 // OPEN_ELEMENT_SPAN
, 42 // STATIC_PROP
, "aria-hidden", true, 44 // STATIC_PROP_CLASS_NAME
...
function UFI2ReactionsCount() {
  return (// UFI2ReactionsCount OPCODES
    ...
    ], UFI2ReactionsCount_ComputeFunction, 0 // VALUE_POINTER_INDEX
    ]]
  );
}
...
function UFI2ReactionIconTooltipTitle() {
  return (// UFI2ReactionIconTooltipTitle OPCODES
    ...
    , [2 // OPEN_ELEMENT_DIV
    , 44 // STATIC_PROP_CLASS_NAME
    , "UFI2ReactionIconTooltipTitle__root", 35 // ELEMENT_DYNAMIC_CHILDREN_VALUE
...
function AbstractLink() {
  return (// AbstractLink OPCODES
    ...
    , 43 // DYNAMIC_PROP
    , "ajaxify", 0, 0, 43 // DYNAMIC_PROP
    , "aria-disabled", 0, 1, 43 // DYNAMIC_PROP
    , "aria-label", 0, 2, 43 // DYNAMIC_PROP
    , "data-testid", 0, 3, 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 4, 43 // DYNAMIC_PROP
    , "tabindex", 8, 5, 43 // DYNAMIC_PROP
    , "target", 0, 6, 43 // DYNAMIC_PROP
    , "href", 0, 7, 15 // MULTI_CONDITIONAL
    , 3 // MULTI_CONDITIONAL_SIZE
    , 0 // HOST_NODE_VALUE_POINTER_INDEX
    , 1 // CASE_VALUE_POINTER_INDEX
    , 8, [43 // DYNAMIC_PROP
    , "rel", 0, 9], 10, [43 // DYNAMIC_PROP
    , "rel", 0, 11], [43 // DYNAMIC_PROP
    , "rel", 0, 12], 52 // DYNAMIC_PROP_REF
    , 0, 13, 40 // ELEMENT_DYNAMIC_CHILDREN_REACT_NODE_TEMPLATE
...
, 44 // STATIC_PROP_CLASS_NAME
, "accessible_elem", 40 // ELEMENT_DYNAMIC_CHILDREN_REACT_NODE_TEMPLATE
...
function AbstractButton() {
  return (// AbstractButton OPCODES
    ...
    , AbstractButton_ComputeFunction, 18 // VALUE_POINTER_INDEX
    ...
    , 43 // DYNAMIC_PROP
    , "ajaxify", 0, 1, 43 // DYNAMIC_PROP
    , "aria-label", 0, 2, 43 // DYNAMIC_PROP
    , "data-testid", 0, 3, 43 // DYNAMIC_PROP
    , "rel", 0, 4, 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 5, 43 // DYNAMIC_PROP
    , "disabled", 32, 6, 43 // DYNAMIC_PROP
    , "href", 0, 7, 43 // DYNAMIC_PROP
    , "type", 0, 8, 39 // ELEMENT_DYNAMIC_CHILD_REACT_NODE_TEMPLATE
    ...
    , [39 // ELEMENT_DYNAMIC_CHILD_REACT_NODE_TEMPLATE
    ...
    , 0, 5, 43 // DYNAMIC_PROP
    , "disabled", 32, 6, 43 // DYNAMIC_PROP
    , "href", 0, 7, 42 // STATIC_PROP
    , "type", "submit", 46 // STATIC_PROP_VALUE
    , "1", 39 // ELEMENT_DYNAMIC_CHILD_REACT_NODE_TEMPLATE
...
function Tooltip() {
  return (// Tooltip OPCODES
    ...
    , 0, 1, 43 // DYNAMIC_PROP
    , "data-testid", 0, 2, 43 // DYNAMIC_PROP
    , "tabindex", 8, 3, 39 // ELEMENT_DYNAMIC_CHILD_REACT_NODE_TEMPLATE
...
function UFI2TopReactions() {
  return (// UFI2TopReactions OPCODES
    ...
    , 43 // DYNAMIC_PROP
    , "aria-label", 0, 0, 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 1, 42 // STATIC_PROP
    , "role", "toolbar", 38 // ELEMENT_DYNAMIC_CHILDREN_ARRAY_MAP_TEMPLATE
    , 2, [13 // UNCONDITIONAL_TEMPLATE
    , [24 // TEMPLATE_FROM_FUNC_CALL
    , __opcodes__11, 0 // COMPUTE_VALUES
    ], 0 // COMPUTE_FUNCTION
    ] // ARRAY_MAP_OPCODES
    , 3 // ARRAY_MAP_COMPUTE_FUNCTION
    , 8 // CLOSE_ELEMENT
    ], UFI2TopReactions_ComputeFunction, 2 // VALUE_POINTER_INDEX
    ]]
  );
}
...
function FeedStoryUFISummary() {
  return (// FeedStoryUFISummary OPCODES
    ...
    , [2 // OPEN_ELEMENT_DIV
    , 44 // STATIC_PROP_CLASS_NAME
    , "fbFeedStoryUFI__feedbackSummary", 42 // STATIC_PROP
    , "data-testid", "fbFeedStoryUFI/feedbackSummary", 16 // CONDITIONAL
    , 0 // VALUE_POINTER_INDEX
    ...
    , 8 // CLOSE_ELEMENT
    ], FeedStoryUFISummary_ComputeFunction, 1 // VALUE_POINTER_INDEX
    ]]
  );
}
...
function UFI2ActionLink_ComputeFunction(children, showIcon) {
  ...
  var showIcon2 = showIcon === undefined ? true : showIcon;
  __cached__12 = children({
    ["className"]: cx("UFI2ActionLink/link") + (showIcon2 ? " " + cx("UFI2ActionLink/withIcon") : "")
  });
  return [__cached__12];
}
...
function UFI2ActionLink() {
  return (// UFI2ActionLink OPCODES
    ...
    , [4 // OPEN_ELEMENT_SPAN
    , 44 // STATIC_PROP_CLASS_NAME
    , "UFI2ActionLink__root", 25 // REACT_NODE_TEMPLATE_FROM_FUNC_CALL
    , 0, 8 // CLOSE_ELEMENT
...
function AWithFocusEvents() {
  return (// AWithFocusEvents OPCODES
    ...
    , 43 // DYNAMIC_PROP
    , "aria-pressed", 0, 0, 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 1, 43 // DYNAMIC_PROP
    , "data-testid", 0, 2, 43 // DYNAMIC_PROP
    , "href", 0, 3, 43 // DYNAMIC_PROP
    , "role", 0, 4, 21 // OPEN_PROP_STYLE
    , 49 // DYNAMIC_PROP_STYLE
    , "color", 5, 22 // CLOSE_PROP_STYLE
    , 43 // DYNAMIC_PROP
    , "tabindex", 8, 6, 8 // CLOSE_ELEMENT
...
function UFIReactionIcon() {
  return (// UFIReactionIcon OPCODES
    ...
    , 0 // HOST_NODE_VALUE_POINTER_INDEX
    , 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 0, 33 // ELEMENT_STATIC_CHILDREN_VALUE
    , 123, 8 // CLOSE_ELEMENT
...
var __hoisted__opcodes__8 = [13 // UNCONDITIONAL_TEMPLATE
, [2 // OPEN_ELEMENT_DIV
, 44 // STATIC_PROP_CLASS_NAME
, "UFI2ReactionActionLink__root", 42 // STATIC_PROP
...
function ShimButton() {
  return (// ShimButton OPCODES
    ...
    , 0 // HOST_NODE_VALUE_POINTER_INDEX
    , 1 // BRANCH_OPCODES_VALUE_POINTER_INDEX
    , ShimButton_ComputeFunction, 9 // VALUE_POINTER_INDEX
    , [0 // CONDITIONAL_ROOT_INDEX
    , [1 // OPEN_ELEMENT_WITH_POINTER
    , "a", 3 // HOST_NODE_VALUE_POINTER_INDEX
    , 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 1, 43 // DYNAMIC_PROP
    , "onClick", 2, 2, 43 // DYNAMIC_PROP
    , "aria-pressed", 0, 3, 42 // STATIC_PROP
    , "role", "button", 35 // ELEMENT_DYNAMIC_CHILDREN_VALUE
    ...
    , 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 2, 43 // DYNAMIC_PROP
    , "onClick", 2, 3, 43 // DYNAMIC_PROP
    , "aria-pressed", 0, 4, 42 // STATIC_PROP
    , "role", "button", 35 // ELEMENT_DYNAMIC_CHILDREN_VALUE
...
var __hoisted__opcodes__9 = [13 // UNCONDITIONAL_TEMPLATE
, [29 // REF_COMPONENT
...
var __hoisted__opcodes__11 = [13 // UNCONDITIONAL_TEMPLATE
, [29 // REF_COMPONENT
, ShareLink, 0 // COMPONENT_PROPS_ARRAY
], 0 // COMPUTE_FUNCTION
];
var __hoisted__opcodes__12 = [13 // UNCONDITIONAL_TEMPLATE
, [5 // OPEN_ELEMENT_SPAN_WITH_POINTER
, 2 // HOST_NODE_VALUE_POINTER_INDEX
, 45 // DYNAMIC_PROP_CLASS_NAME
...
function UFI2ShareActionLink() {
  return (// UFI2ShareActionLink OPCODES
    ...
    , 0 // HOST_NODE_VALUE_POINTER_INDEX
    , 1 // BRANCH_OPCODES_VALUE_POINTER_INDEX
    , UFI2ShareActionLink_ComputeFunction, 3 // VALUE_POINTER_INDEX
    , [0 // CONDITIONAL_ROOT_INDEX
    , [29 // REF_COMPONENT
    , UFI2ActionLink, 1 // COMPONENT_PROPS_ARRAY
    ], 1 // CONDITIONAL_ROOT_INDEX
...
function ShareLink() {
  return (// ShareLink OPCODES
    ...
    , 43 // DYNAMIC_PROP
    , "href", 0, 0, 45 // DYNAMIC_PROP_CLASS_NAME
    , 0, 1, 42 // STATIC_PROP
    , "data-ft", "{ &quot;tn&quot;: &quot;dummy&quot;, &quot;type&quot;: 25 }", 43 // DYNAMIC_PROP
    , "rel", 0, 2, 42 // STATIC_PROP
    , "role", "button", 42 // STATIC_PROP
    , "tabindex", 0, 43 // DYNAMIC_PROP
    , "title", 0, 3, 34 // ELEMENT_DYNAMIC_CHILD_VALUE
...
, 45 // DYNAMIC_PROP_CLASS_NAME
, 0, 0, 42 // STATIC_PROP
, "role", "progressbar", 43 // DYNAMIC_PROP
, "aria-valuetext", 0, 1, 42 // STATIC_PROP
, "aria-busy", "true", 42 // STATIC_PROP
, "aria-valuemin", "0", 42 // STATIC_PROP
