...
function UFI2ReactionIconTooltipTitle_ComputeFunction // COMPUTE_FUNCTION
(children) {
  return [children];
}
...
function UFI2ReactionIconTooltipTitle() {
  return (// UFI2ReactionIconTooltipTitle OPCODES
    ...
    , 0, 10 // CLOSE_ELEMENT
    ], UFI2ReactionIconTooltipTitle_ComputeFunction])]
  );
}
...
function AWithFocusEvents_ComputeFunction // COMPUTE_FUNCTION
(aria_pressed, children, className, data_testid, href, onKeyboardFocus, onMouseFocus, role, style, tabIndex) {
...
function AWithFocusEvents() {
  return (// AWithFocusEvents OPCODES
    ...
    ], AWithFocusEvents_ComputeFunction])]
  );
}

function UFI2ReactionLink_ComputeFunction // COMPUTE_FUNCTION
(children, className, feedback) {
  var state = {
    ["menuShown"]: false
  };
...
function UFI2ReactionLink() {
  return (// UFI2ReactionLink OPCODES
    ...
    , null // CONDITIONAL_ALTERNATE
    , 13 // CLOSE_FRAGMENT
    ], UFI2ReactionLink_ComputeFunction])]
  );
}
...
var __hoisted__opcodes__7 = [20 // UNCONDITIONAL_TEMPLATE
, [29 // REF_COMPONENT
, ShimButton, 0 // COMPONENT_PROPS_ARRAY
], null // COMPUTE_FUNCTION
];

function UFI2AnswerActionLink_ComputeFunction // COMPUTE_FUNCTION
(className, feedback, onClick) {
  (function (): React.Node {
  ...
  return [feedback && feedback["can_viewer_comment"] && feedback["is_q_and_a"], [(_ref: {
    className: string
  }) => createReactNode(__hoisted__opcodes__7, function (): React.Node {
    var actionLinkClassName = _ref["className"];
    joinClasses(cx("UFI2AnswerActionLink/root"), actionLinkClassName, className);
    fbt["_"]("Answer", null, {
      ["hash_key"]: "7wbRt"
...
function UFI2AnswerActionLink() {
  return (// UFI2AnswerActionLink OPCODES
    ...
    , [2 // ROOT_STATIC_VALUE
    , null] // CONDITIONAL_ALTERNATE
    ], UFI2AnswerActionLink_ComputeFunction])]
  );
}

function UFI2CommentActionLink_ComputeFunction // COMPUTE_FUNCTION
(className, feedback, onClick) {
  (function (): React.Node {
    var actionLinkClassName = _ref["className"];
...
function UFI2CommentActionLink() {
  return (// UFI2CommentActionLink OPCODES
    ...
    , [2 // ROOT_STATIC_VALUE
    , null] // CONDITIONAL_ALTERNATE
    ], UFI2CommentActionLink_ComputeFunction])]
  );
}
...
(className, feedback, feedbackTargetID, shareableConfig) {
  ...
  (function (): React.Node {
    ...
    __cached__16 = joinClasses(cx("UFI2ShareActionLink/root"), className);
    return [__cached__16, [_ref9["className"], void 0, false, void 0]];
  });
...
function ShareLink_ComputeFunction // COMPUTE_FUNCTION
(className, href, isLoading, rel) {
  var __cached__15;
  ...
  __cached__15 = fbt["_"]("Share", null, {
    ["hash_key"]: "gaj3j"
  });
  __cached__14 = joinClasses(cx("UFI2ShareActionLink/link"), className);
  return [$ShareLink_getQualifiedHref(props) || "#", __cached__14, rel, "work user" ? fbt["_"]("Send this to coworkers or post it on your timeline.", null, {
    ["hash_key"]: "2zccV8"
  }) : fbt["_"]("Send this to friends or post it on your timeline.", null, {
    ["hash_key"]: "Y9LzE"
  }), __cached__15, isLoading === true];
}
...
function ShareLink() {
  return (// ShareLink OPCODES
    ...
    , 4, 30 // CONDITIONAL
    , 5, [29 // REF_COMPONENT
    , XUISpinner, null // COMPONENT_PROPS_ARRAY
    ] // CONDITIONAL_CONSEQUENT
    , null // CONDITIONAL_ALTERNATE
    , 10 // CLOSE_ELEMENT
    ], ShareLink_ComputeFunction])]
  );
}
...
var __hoisted__opcodes__10 = [8 // OPEN_ELEMENT_DIV
, 62 // STATIC_PROP_CLASS_NAME
...
(contextForFeedback, feedLocation, feedback, feedbackSource, feedbackTargetID, linkedCommentId, shareable_config) {
  ...
  return [[createReactNode(__hoisted__opcodes__10, [[feedback, feedbackTargetID, null], [void 0, feedback], feedback["is_q_and_a"], [void 0, feedback, null], [void 0, feedback, null], [void 0, feedback, feedbackTargetID, shareable_config]])]];
}
