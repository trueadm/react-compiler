...
function ReactImage0({ x }: { x?: number }) {
  if (x === 0) {
...
function AbstractLink1({ x }: { x?: number }) {
  if (x === 1) {
    return React.createElement(
      "a",
      {
  ...
  if (x === 207) {
    return React.createElement("a", { href: "#", rel: undefined, onClick: function(): void {} }, "Create Ad Set");
  }
  if (x === 209) {
    return React.createElement("a", { href: "#", rel: undefined, onClick: function(): void {} }, "View Ad Set");
  }
  if (x === 241) {
    return React.createElement("a", { href: "#", rel: undefined, onClick: function(): void {} }, "Set a Limit");
  }
  if (x === 267) {
    return React.createElement(
      "a",
...
function AbstractButton3({ x }: { x?: number }) {
  if (x === 3) {
...
function XUIButton4({ x }: { x?: number }) {
  if (x === 4) {
...
function AbstractPopoverButton5({ x }: { x?: number }) {
  if (x === 5) {
...
function ReactXUIPopoverButton6({ x }: { x?: number }) {
  if (x === 6) {
...
function BIGAdAccountSelector7({ x }: { x?: number }) {
  if (x === 7) {
    return React.createElement("div", null, React.createElement(ReactXUIPopoverButton6, { x: 6 }), null);
  }
};

function FluxContainer_AdsPEBIGAdAccountSelectorContainer_8({ x }: { x?: number }) {
  if (x === 8) {
    return React.createElement(BIGAdAccountSelector7, { x: 7 });
  }
};

function ErrorBoundary9({ x }: { x?: number }) {
  if (x === 9) {
...
function AdsErrorBoundary10({ x }: { x?: number }) {
  if (x === 10) {
...
function AdsPENavigationBar11({ x }: { x?: number }) {
  if (x === 11) {
    return React.createElement("div", { className: "_4t_9" });
  }
};

function FluxContainer_AdsPENavigationBarContainer_12({ x }: { x?: number }) {
  if (x === 12) {
    return React.createElement(AdsPENavigationBar11, { x: 11 });
  }
};

function AdsPEDraftSyncStatus13({ x }: { x?: number }) {
  if (x === 16) {
    return React.createElement(
      "div",
      { className: "_3ut-", onClick: function(): void {} },
      React.createElement("span", { className: "_3uu0" }, React.createElement(ReactImage0, { x: 15 })),
    );
  }
};

function FluxContainer_AdsPEDraftSyncStatusContainer_14({ x }: { x?: number }) {
  if (x === 17) {
    return React.createElement(AdsPEDraftSyncStatus13, { x: 16 });
  }
};

function AdsPEDraftErrorsStatus15({ x }: { x?: number }) {
  if (x === 18) {
    return null;
  }
};

function FluxContainer_viewFn_16({ x }: { x?: number }) {
  if (x === 19) {
    return React.createElement(AdsPEDraftErrorsStatus15, { x: 18 });
  }
};

function AdsPEPublishButton17({ x }: { x?: number }) {
  if (x === 25) {
    return React.createElement(
      "div",
      { className: "_5533" },
...
function FluxContainer_AdsPEPublishButtonContainer_18({ x }: { x?: number }) {
  if (x === 26) {
    return React.createElement(AdsPEPublishButton17, { x: 25 });
  }
};

function InlineBlock19({ x }: { x?: number }) {
  if (x === 30) {
    return React.createElement(
      "div",
...
function ReactPopoverMenu20({ x }: { x?: number }) {
  if (x === 31) {
...
function LeftRight21({ x }: { x?: number }) {
  if (x === 34) {
    return React.createElement(
      "div",
      { className: "clearfix" },
...
function FluxContainer_AdsPETopNavContainer_26({ x }: { x?: number }) {
  if (x === 41) {
    return React.createElement(AdsPETopNav25, { x: 40 });
  }
};

function XUIAbstractGlyphButton27({ x }: { x?: number }) {
  if (x === 46) {
...
function XUICloseButton28({ x }: { x?: number }) {
  if (x === 47) {
...
function XUINotice30({ x }: { x?: number }) {
  if (x === 51) {
    return React.createElement(
      "div",
...
function FluxContainer_AdsPETopErrorContainer_35({ x }: { x?: number }) {
  if (x === 56) {
    return React.createElement(AdsPETopError34, { x: 55 });
  }
};

function FluxContainer_AdsGuidanceChannel_36({ x }: { x?: number }) {
  if (x === 59) {
    return null;
  }
};

function ResponsiveBlock37({ x }: { x?: number }) {
  if (x === 62) {
    return React.createElement(
      "div",
      { className: "_4u-c" },
...
function FluxContainer_AdsBulkEditDialogContainer_38({ x }: { x?: number }) {
  if (x === 63) {
    return null;
  }
};

function Column39({ x }: { x?: number }) {
  if (x === 66) {
    return React.createElement(
      "div",
...
function XUIButtonGroup40({ x }: { x?: number }) {
  if (x === 75) {
    return React.createElement(
      "div",
...
function AdsPEEditToolbarButton41({ x }: { x?: number }) {
  if (x === 85) {
    return React.createElement(XUIButtonGroup40, { x: 84 });
  }
};

function FluxContainer_AdsPEEditCampaignGroupToolbarButtonContainer_42({ x }: { x?: number }) {
  if (x === 86) {
    return React.createElement(AdsPEEditToolbarButton41, { x: 85 });
  }
};

function FluxContainer_AdsPEEditToolbarButtonContainer_43({ x }: { x?: number }) {
  if (x === 87) {
    return React.createElement(FluxContainer_AdsPEEditCampaignGroupToolbarButtonContainer_42, { x: 86 });
  }
};

function AdsPEExportImportMenu44({ x }: { x?: number }) {
  if (x === 103) {
    return React.createElement(ReactPopoverMenu20, { x: 102, key: "export" });
  }
};

function FluxContainer_AdsPECustomizeExportContainer_45({ x }: { x?: number }) {
  if (x === 104) {
    return null;
  }
};

function AdsPEExportAsTextDialog46({ x }: { x?: number }) {
  if (x === 105) {
    return null;
  }
};

function FluxContainer_AdsPEExportAsTextDialogContainer_47({ x }: { x?: number }) {
  if (x === 106) {
    return React.createElement(AdsPEExportAsTextDialog46, { x: 105 });
  }
};

function AdsPEExportImportMenuContainer48({ x }: { x?: number }) {
  if (x === 107) {
    return React.createElement(
      "span",
      null,
...
function Constructor49({ x }: { x?: number }) {
  if (x === 114) {
    return null;
  }
  if (x === 142) {
...
function TagSelectorPopover50({ x }: { x?: number }) {
  if (x === 115) {
    return React.createElement(
      "span",
      { className: " _3d6e" },
...
function AdsPECampaignGroupTagContainer51({ x }: { x?: number }) {
  if (x === 116) {
...
function AdsRuleToolbarMenu52({ x }: { x?: number }) {
  if (x === 118) {
    return null;
  }
};

function FluxContainer_AdsPERuleToolbarMenuContainer_53({ x }: { x?: number }) {
  if (x === 119) {
    return React.createElement(AdsRuleToolbarMenu52, { x: 118 });
  }
};

function FillColumn54({ x }: { x?: number }) {
  if (x === 120) {
    return React.createElement(
      "div",
      { className: "_4bl9" },
...
function AbstractCheckboxInput59({ x }: { x?: number }) {
  if (x === 145) {
    return React.createElement(
      "label",
...
function XUICheckboxInput60({ x }: { x?: number }) {
  if (x === 146) {
...
function InputLabel61({ x }: { x?: number }) {
  if (x === 147) {
    return React.createElement(
      "div",
...
function AdsPopoverLink62({ x }: { x?: number }) {
  if (x === 154) {
    return React.createElement(
      "span",
      null,
...
function AdsHelpLink63({ x }: { x?: number }) {
  if (x === 155) {
...
function BUIFilterTokenInput64({ x }: { x?: number }) {
  if (x === 158) {
    return React.createElement(
      "div",
...
function BUIFilterToken65({ x }: { x?: number }) {
  if (x === 159) {
    return React.createElement(
      "div",
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { onClick: function(): void {}, className: "_3yz5" },
...
function BUIFilterTokenCreateButton66({ x }: { x?: number }) {
  if (x === 163) {
    return React.createElement("div", { className: "_1tc" }, React.createElement(XUIButton4, { x: 162 }));
  }
};

function BUIFilterTokenizer67({ x }: { x?: number }) {
  if (x === 164) {
    return React.createElement(
      "div",
...
function XUIAmbientNUX68({ x }: { x?: number }) {
  if (x === 165) {
    return null;
  }
  if (x === 189) {
...
function XUIAmbientNUX69({ x }: { x?: number }) {
  if (x === 166) {
...
function AdsPEAmbientNUXMegaphone70({ x }: { x?: number }) {
  if (x === 167) {
    return React.createElement(
      "span",
      null,
...
function AdsPEFilters71({ x }: { x?: number }) {
  if (x === 168) {
    return React.createElement(
      "div",
      { className: "_4rw_" },
...
function AdsPEFilterContainer72({ x }: { x?: number }) {
  if (x === 169) {
    return React.createElement(AdsPEFilters71, { x: 168 });
  }
};

function AdsPETablePager73({ x }: { x?: number }) {
  if (x === 172) {
    return null;
  }
};

function AdsPECampaignGroupTablePagerContainer74({ x }: { x?: number }) {
  if (x === 173) {
    return React.createElement(AdsPETablePager73, { x: 172 });
  }
};

function AdsPETablePagerContainer75({ x }: { x?: number }) {
  if (x === 174) {
...
function ReactXUIError76({ x }: { x?: number }) {
  if (x === 181) {
...
function BUIPopoverButton77({ x }: { x?: number }) {
  if (x === 182) {
    return React.createElement(ReactXUIError76, { x: 181 });
  }
};

function BUIDateRangePicker78({ x }: { x?: number }) {
  if (x === 184) {
...
function AdsPEStatsRangePicker79({ x }: { x?: number }) {
  if (x === 185) {
    return React.createElement(BUIDateRangePicker78, { x: 184 });
  }
};

function AdsPEStatRange80({ x }: { x?: number }) {
  if (x === 191) {
    return React.createElement(
      "div",
      { className: "_3c5k" },
...
function AdsPEStatRangeContainer81({ x }: { x?: number }) {
  if (x === 192) {
    return React.createElement(AdsPEStatRange80, { x: 191 });
  }
};

function AdsPESideTrayTabButton82({ x }: { x?: number }) {
  if (x === 196) {
    return React.createElement(
      "div",
      { className: "_1-ly _59j9 _d9a", onClick: function(): void {} },
  ...
  if (x === 199) {
    return React.createElement(
      "div",
      { className: " _1-lz _d9a", onClick: function(): void {} },
...
function AdsPEEditorTrayTabButton83({ x }: { x?: number }) {
  if (x === 197) {
    return React.createElement(AdsPESideTrayTabButton82, { x: 196 });
  }
};

function AdsPEInsightsTrayTabButton84({ x }: { x?: number }) {
  if (x === 202) {
    return React.createElement(
      "span",
      null,
...
function AdsPENekoDebuggerTrayTabButton85({ x }: { x?: number }) {
  if (x === 204) {
    return React.createElement(AdsPESideTrayTabButton82, { x: 203 });
  }
};

function AdsPEEditorChildLink86({ x }: { x?: number }) {
  if (x === 211) {
    return React.createElement(
      "div",
      { className: "_3ywr" },
...
function AdsPEEditorChildLinkContainer87({ x }: { x?: number }) {
  if (x === 212) {
    return React.createElement(AdsPEEditorChildLink86, { x: 211 });
  }
};

function AdsPEHeaderSection88({ x }: { x?: number }) {
  if (x === 213) {
    return React.createElement(
      "div",
      { className: "_yke" },
...
function AdsPECampaignGroupHeaderSectionContainer89({ x }: { x?: number }) {
  if (x === 214) {
    return React.createElement(AdsPEHeaderSection88, { x: 213 });
  }
};

function AdsEditorLoadingErrors90({ x }: { x?: number }) {
  if (x === 215) {
    return null;
  }
};

function AdsTextInput91({ x }: { x?: number }) {
  if (x === 217) {
    return React.createElement(ReactXUIError76, { x: 216 });
  }
};

function BUIFormElement92({ x }: { x?: number }) {
  if (x === 218) {
    return React.createElement(
      "div",
...
function AdsEditorNameSection96({ x }: { x?: number }) {
  if (x === 223) {
    return React.createElement(AdsCard95, { x: 222 });
  }
};

function AdsCampaignGroupNameSectionContainer97({ x }: { x?: number }) {
  if (x === 224) {
...
function AdsPluginWrapper99({ x }: { x?: number }) {
  if (x === 226) {
...
function XUICardHeaderTitle100({ x }: { x?: number }) {
  if (x === 227) {
    return React.createElement(
      "span",
      { className: "_38my" },
...
function XUICardSection101({ x }: { x?: number }) {
  if (x === 228) {
    return React.createElement(
      "div",
...
function XUICardHeader102({ x }: { x?: number }) {
  if (x === 229) {
    return React.createElement(XUICardSection101, { x: 228 });
  }
};

function AdsCardHeader103({ x }: { x?: number }) {
  if (x === 230) {
    return React.createElement(XUICardHeader102, { x: 229 });
  }
};

function AdsLabeledField104({ x }: { x?: number }) {
  if (x === 231) {
    return React.createElement(
      "div",
...
function FlexibleBlock105({ x }: { x?: number }) {
  if (x === 233) {
...
function AdsBulkCampaignSpendCapField106({ x }: { x?: number }) {
  if (x === 243) {
    return React.createElement(
      "div",
      { className: "_33dv" },
...
function FluxContainer_AdsCampaignGroupSpendCapContainer_107({ x }: { x?: number }) {
  if (x === 244) {
    return React.createElement(AdsBulkCampaignSpendCapField106, { x: 243 });
  }
};

function AdsCardSection108({ x }: { x?: number }) {
  if (x === 248) {
    return React.createElement(XUICardSection101, { x: 247 });
  }
};

function AdsEditorCampaignGroupDetailsSection109({ x }: { x?: number }) {
  if (x === 252) {
    return React.createElement(AdsCard95, { x: 251 });
  }
};

function AdsEditorCampaignGroupDetailsSectionContainer110({ x }: { x?: number }) {
  if (x === 253) {
...
function _render111({ x }: { x?: number }) {
  if (x === 254) {
    return React.createElement(AdsEditorCampaignGroupDetailsSectionContainer110, { x: 253 });
  }
};

function FluxContainer_AdsEditorToplineDetailsSectionContainer_112({ x }: { x?: number }) {
  if (x === 256) {
    return null;
  }
};

function _render113({ x }: { x?: number }) {
  if (x === 257) {
    return React.createElement(FluxContainer_AdsEditorToplineDetailsSectionContainer_112, { x: 256 });
  }
};

function AdsStickyArea114({ x }: { x?: number }) {
  if (x === 259) {
    return React.createElement("div", {}, React.createElement("div", { onWheel: function(): void {} }));
  }
  if (x === 292) {
    return React.createElement(
      "div",
      {},
      React.createElement("div", { onWheel: function(): void {} }, [
        React.createElement(
          "div",
...
function FluxContainer_AdsEditorColumnContainer_115({ x }: { x?: number }) {
  if (x === 260) {
    return React.createElement(
      "div",
      null,
...
function BUISwitch116({ x }: { x?: number }) {
  if (x === 261) {
    return React.createElement(
      "div",
      {
...
function AdsStatusSwitchInternal117({ x }: { x?: number }) {
  if (x === 262) {
    return React.createElement(BUISwitch116, { x: 261 });
  }
};

function AdsStatusSwitch118({ x }: { x?: number }) {
  if (x === 263) {
    return React.createElement(AdsStatusSwitchInternal117, { x: 262 });
  }
};

function FluxContainer_AdsCampaignGroupStatusSwitchContainer_119({ x }: { x?: number }) {
  if (x === 264) {
...
function AdsEditorMultiColumnLayout131({ x }: { x?: number }) {
  if (x === 294) {
    return React.createElement(
      "div",
      { className: "_psh" },
...
function AdsPECampaignGroupEditor132({ x }: { x?: number }) {
  if (x === 295) {
    return React.createElement(
      "div",
      null,
...
function AdsPECampaignGroupEditorContainer133({ x }: { x?: number }) {
  if (x === 296) {
    return React.createElement(AdsPECampaignGroupEditor132, { x: 295 });
  }
};

function AdsPESideTrayTabContent134({ x }: { x?: number }) {
  if (x === 297) {
    return React.createElement(
      "div",
...
function AdsPEEditorTrayTabContentContainer135({ x }: { x?: number }) {
  if (x === 298) {
    return React.createElement(AdsPESideTrayTabContent134, { x: 297 });
  }
};

function AdsPEMultiTabDrawer136({ x }: { x?: number }) {
  if (x === 299) {
    return React.createElement(
      "div",
...
function FluxContainer_AdsPEMultiTabDrawerContainer_137({ x }: { x?: number }) {
  if (x === 300) {
    return React.createElement(AdsPEMultiTabDrawer136, { x: 299 });
  }
};

function AdsPESimpleOrganizer138({ x }: { x?: number }) {
  if (x === 309) {
    return React.createElement(
      "div",
      { className: "_tm2" },
...
function AdsPEOrganizerContainer139({ x }: { x?: number }) {
  if (x === 310) {
    return React.createElement("div", null, React.createElement(AdsPESimpleOrganizer138, { x: 309 }));
  }
};

function FixedDataTableColumnResizeHandle140({ x }: { x?: number }) {
  if (x === 313) {
    return React.createElement(
      "div",
      {
...
function AdsPETableHeader141({ x }: { x?: number }) {
  if (x === 315) {
    return React.createElement(
      "div",
...
function TransitionCell142({ x }: { x?: number }) {
  if (x === 316) {
    return React.createElement(
      "div",
      {
...
function FixedDataTableCell143({ x }: { x?: number }) {
  if (x === 317) {
    return React.createElement(
      "div",
  ...
  if (x === 344) {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "_4lg9", style: { height: 25 }, onMouseDown: function(): void {} },
        React.createElement("div", {
...
function FixedDataTableCellGroupImpl144({ x }: { x?: number }) {
  if (x === 318) {
    return React.createElement(
      "div",
      {
...
function FixedDataTableCellGroup145({ x }: { x?: number }) {
  if (x === 319) {
    return React.createElement(
      "div",
...
function FixedDataTableRowImpl146({ x }: { x?: number }) {
  if (x === 334) {
    return React.createElement(
      "div",
      {
...
function FixedDataTableRow147({ x }: { x?: number }) {
  if (x === 335) {
    return React.createElement(
      "div",
      {
...
function FixedDataTableAbstractSortableHeader148({ x }: { x?: number }) {
  if (x === 341) {
    return React.createElement(
      "div",
      { onClick: function(): void {}, className: "_54_8 _4h2r _2wzx" },
  ...
  if (x === 347) {
    return React.createElement(
      "div",
      { onClick: function(): void {}, className: "_54_8 _1kst _4h2r _2wzx" },
  ...
  if (x === 363) {
    return React.createElement(
      "div",
      { onClick: function(): void {}, className: "_54_8 _54_9 _4h2r _2wzx" },
...
function FixedDataTableSortableHeader149({ x }: { x?: number }) {
  if (x === 342) {
...
function FixedDataTableBufferedRows150({ x }: { x?: number }) {
  if (x === 459) {
    return React.createElement("div", {
      style: {
        position: "absolute",
...
function Scrollbar151({ x }: { x?: number }) {
  if (x === 460) {
    return null;
  }
  if (x === 461) {
...
function HorizontalScrollbar152({ x }: { x?: number }) {
  if (x === 462) {
    return React.createElement(
      "div",
...
function FixedDataTable153({ x }: { x?: number }) {
  if (x === 463) {
    return React.createElement(
      "div",
      {
...
function TransitionTable154({ x }: { x?: number }) {
  if (x === 464) {
    return React.createElement(FixedDataTable153, { x: 463 });
  }
};

function AdsSelectableFixedDataTable155({ x }: { x?: number }) {
  if (x === 465) {
    return React.createElement("div", { className: "_5hht" }, React.createElement(TransitionTable154, { x: 464 }));
  }
};

function AdsDataTableKeyboardSupportDecorator156({ x }: { x?: number }) {
  if (x === 466) {
    return React.createElement(
      "div",
      { className: "_5d6f", tabIndex: "0", onKeyDown: function(): void {} },
      React.createElement(AdsSelectableFixedDataTable155, { x: 465 }),
    );
  }
};

function AdsEditableDataTableDecorator157({ x }: { x?: number }) {
  if (x === 467) {
    return React.createElement(
      "div",
...
function AdsPEDataTableContainer158({ x }: { x?: number }) {
  if (x === 468) {
    return React.createElement(
      "div",
...
function AdsPECampaignGroupTableContainer159({ x }: { x?: number }) {
  if (x === 470) {
    return React.createElement(ResponsiveBlock37, { x: 469 });
  }
};

function AdsPEManageAdsPaneContainer160({ x }: { x?: number }) {
  if (x === 473) {
    return React.createElement(
      "div",
      null,
...
function AdsPEContentContainer161({ x }: { x?: number }) {
  if (x === 474) {
    return React.createElement(AdsPEManageAdsPaneContainer160, { x: 473 });
  }
};

function FluxContainer_AdsPEWorkspaceContainer_162({ x }: { x?: number }) {
  if (x === 477) {
    return React.createElement(
      "div",
...
function FluxContainer_AdsSessionExpiredDialogContainer_163({ x }: { x?: number }) {
  if (x === 478) {
    return null;
  }
};

function FluxContainer_AdsPEUploadDialogLazyContainer_164({ x }: { x?: number }) {
  if (x === 479) {
    return null;
  }
};

function FluxContainer_DialogContainer_165({ x }: { x?: number }) {
  if (x === 480) {
    return null;
  }
};

function AdsBugReportContainer166({ x }: { x?: number }) {
  if (x === 481) {
    return React.createElement("span", null);
  }
};

function AdsPEAudienceSplittingDialog167({ x }: { x?: number }) {
  if (x === 482) {
    return null;
  }
};

function AdsPEAudienceSplittingDialogContainer168({ x }: { x?: number }) {
  if (x === 483) {
    return React.createElement("div", null, React.createElement(AdsPEAudienceSplittingDialog167, { x: 482 }));
  }
};

function FluxContainer_AdsRuleDialogBootloadContainer_169({ x }: { x?: number }) {
  if (x === 484) {
    return null;
  }
};

function FluxContainer_AdsPECFTrayContainer_170({ x }: { x?: number }) {
  if (x === 485) {
    return null;
  }
};

function FluxContainer_AdsPEDeleteDraftContainer_171({ x }: { x?: number }) {
  if (x === 486) {
    return null;
  }
};

function FluxContainer_AdsPEInitialDraftPublishDialogContainer_172({ x }: { x?: number }) {
  if (x === 487) {
    return null;
  }
};

function FluxContainer_AdsPEReachFrequencyStatusTransitionDialogBootloadContainer_173({ x }: { x?: number }) {
  if (x === 488) {
    return null;
  }
};

function FluxContainer_AdsPEPurgeArchiveDialogContainer_174({ x }: { x?: number }) {
  if (x === 489) {
    return null;
  }
};

function AdsPECreateDialogContainer175({ x }: { x?: number }) {
  if (x === 490) {
    return React.createElement("span", null);
  }
};

function FluxContainer_AdsPEModalStatusContainer_176({ x }: { x?: number }) {
  if (x === 491) {
    return null;
  }
};

function FluxContainer_AdsBrowserExtensionErrorDialogContainer_177({ x }: { x?: number }) {
  if (x === 492) {
    return null;
  }
};

function FluxContainer_AdsPESortByErrorTipContainer_178({ x }: { x?: number }) {
  if (x === 493) {
    return null;
  }
};

function LeadDownloadDialogSelector179({ x }: { x?: number }) {
  if (x === 494) {
    return null;
  }
}

function FluxContainer_AdsPELeadDownloadDialogContainerClass_180({ x }: { x?: number }) {
  if (x === 495) {
    return React.createElement(LeadDownloadDialogSelector179, { x: 494 });
  }
}

function AdsPEContainer181({ x }: { x: number }) {
  if (x === 496) {
    return React.createElement(
      "div",
      { id: "ads_pe_container" },
