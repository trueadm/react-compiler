...
function AbstractButton_ComputeFunction(ajaxify, aria_label, className, data_testid, depressed, disabled, href, image, imageRight, label, labelIsHidden, rel, role, tabIndex, type) {
  ...
  if (href) {
    ...
    return [0, [ajaxify, void 0, isDisabledButton ? true : undefined, aria_label, [image, labelIsHidden ? createVNode([1090, "span", ["className", 0, "accessible_elem"], [14, 0]], [label]) : label, imageRight], joinClasses(className, _className), data_testid, href, void 0, null, rel, void 0, disabled ? -1 : tabIndex, void 0]];
...
function UFI2TopReactions_ComputeFunction(className, feedback, feedbackTargetID) {
  ...
  function $UFI2TopReactions_renderLink(actorID: string, reactionEdge: Edge, reactionIndex: number): React.Node {
    ...
    return [[createVNode([12, AbstractButton, 0], [[__cached__5["ajaxify"], fbt["_"]("{i18nReactionCount} {i18nReactionName}", [fbt["_param"]("i18nReactionCount", i18nReactionCount), fbt["_param"]("i18nReactionName", i18nReactionName)], {
      ["hash_key"]: "1yBDpL"
    }), cx("UFI2TopReactions/link"), void 0, void 0, void 0, __cached__5["href"], void 0, void 0, [createVNode([12, UFIReactionIcon, 0], [[cx("UFI2TopReactions/icon"), "16"]])], void 0, __cached__5["rel"], "button", reactionsNotFocused && reactionIndex === 0 || currentReactionIsFocused ? 0 : -1, void 0]]), cx("UFI2TopReactions/tooltip"), null, {
      ["feedbackTargetID"]: feedbackTargetID,
      ["i18nReactionName"]: i18nReactionName,
      ["reactionType"]: reactionType
    }, "UFI2TopReactions/tooltip_" + reactionType, void 0, createVNode([2050, "div", [[12, UFI2ReactionIconTooltipTitle, 0], [3, 1]]], [[reactionEdge != null ? reactionEdge["node"] != null ? reactionEdge["node"]["localized_name"] : reactionEdge["node"] : reactionEdge], __cached__7]), -1]];
  }
...
function FeedStoryUFISummary_ComputeFunction(feedback, feedbackTargetID, onClickCommentsCount) {
  ...
  return [reaction_count != null ? reaction_count["count"] : reaction_count, [createVNode([12, UFI2TopReactions, 0], [[cx("fbFeedStoryUFI/topReactions"), feedback, feedbackTargetID]]), void 0], [createVNode([12, UFI2ReactionsCount, 0], [[feedback, feedbackTargetID]]), void 0]];
}
...
function UFI2AnswerActionLink_ComputeFunction(className, feedback, onClick) {
  ...
  return [feedback && feedback["can_viewer_comment"] && feedback["is_q_and_a"], [(_ref: {
    className: string
  }) => createVNode([12, ShimButton, 0], function (): React.Node {
    var actionLinkClassName = _ref["className"];
    joinClasses(cx("UFI2AnswerActionLink/root"), actionLinkClassName, className);
    fbt["_"]("Answer", null, {
      ["hash_key"]: "7wbRt"
...
function UFI2ShareActionLink_ComputeFunction(className, feedback, feedbackTargetID, shareableConfig) {
  ...
  if (misinformationConfirmDialogURI && !misinformationDialogConfirmed) {
    ...
    return [0, [(_ref7: {
      className: string
    }) => createVNode([12, ShareLink, 0], function (): React.Node {
      return [[_ref7["className"], void 0, void 0, void 0]];
    }()), void 0]];
  }
  ...
  return [1, [(_ref9: {
    className: string
  }) => createVNode([1154, "span", ["className", 0, 0], [12, ShareLink, 1]], function (): React.Node {
    var __cached__17;
...
function FeedStoryUFIRootRenderer_ComputeFunction(contextForFeedback, feedLocation, feedback, feedbackSource, feedbackTargetID, linkedCommentId, shareable_config) {
  ...
  return [[createVNode([2114, "div", ["className", 0, "fbFeedStoryUFI__summaryAndActionsContainer"], [[12, FeedStoryUFISummary, 0], [2114, "div", ["className", 0, "fbFeedStoryUFI__actionLinks"], [[12, UFI2ReactionActionLink, 1], [6, 2, [12, UFI2AnswerActionLink, 3], [12, UFI2CommentActionLink, 4]], [12, UFI2ShareActionLink, 5]]]]], [[feedback, feedbackTargetID, null], [void 0, feedback], feedback["is_q_and_a"], [void 0, feedback, null], [void 0, feedback, null], [void 0, feedback, feedbackTargetID, shareable_config]])]];
}
...
const OnVisible = [1, OnVisible_ComputeFunction, [4, 0]];
const UFI2RealtimeContainer = [1, UFI2RealtimeContainer_ComputeFunction, [12, OnVisible, 0]];
const ErrorBoundary = [1, ErrorBoundary_ComputeFunction, [4, 0]];
const UFI2ErrorBoundary = [1, UFI2ErrorBoundary_ComputeFunction, [12, ErrorBoundary, 0]];
const Tooltip = [1, Tooltip_ComputeFunction, [6, 0, [1154, "div", ["className", 0, 1, "data-testid", 0, 2, "tabindex", 0, 3], [14, 5]], [1154, "span", ["className", 0, 1, "data-testid", 0, 2, "tabindex", 0, 3], [14, 5]]]];
const LazyContentTooltip = [1, LazyContentTooltip_ComputeFunction, [12, Tooltip, 0]];
const AbstractLink = [1, AbstractLink_ComputeFunction, [1154, "a", ["ajaxify", 0, 0, "aria-disabled", 0, 1, "aria-label", 0, 2, "data-testid", 0, 3, "className", 0, 4, "tabindex", 0, 5, "target", 0, 6, "href", 0, 7, "rel", 0, 8], [14, 9]]];
const Link = [1, Link_ComputeFunction, [12, AbstractLink, 0]];
const AbstractButton = [1, AbstractButton_ComputeFunction, [15, 0, [12, Link, 1], 1, [2178, "button", ["ajaxify", 0, 1, "aria-label", 0, 2, "data-testid", 0, 3, "rel", 0, 4, "className", 0, 5, "disabled", 2, 6, "href", 0, 7, "type", 0, 8], [[14, 9], [6, 10, [1090, "span", ["className", 0, "accessible_elem"], [14, 11]], [4, 11]], [14, 12]]], 2, [2242, "button", ["type", 0, "submit", "value", 0, "1"], ["ajaxify", 0, 1, "aria-label", 0, 2, "data-testid", 0, 3, "rel", 0, 4, "className", 0, 5, "disabled", 2, 6, "href", 0, 7], [[14, 8], [6, 9, [1090, "span", ["className", 0, "accessible_elem"], [14, 10]], [4, 10]], [14, 11]]]]];
...
const UFI2TopReactions = [1, UFI2TopReactions_ComputeFunction, [1218, "span", ["role", 0, "toolbar"], ["aria-label", 0, 0, "className", 0, 1], [16, 2]]];
...
const UFI2ActionLink = [1, UFI2ActionLink_ComputeFunction, [1090, "span", ["className", 0, "UFI2ActionLink__root"], [14, 1]]];
...
const UFI2ReactionLink = [1, UFI2ReactionLink_ComputeFunction, [5, [[12, AWithFocusEvents, 0], [6, 1, [32772, null], [32772, null]]]]];
const UFI2ReactionActionLink = [1, UFI2ReactionActionLink_ComputeFunction, [6, 0, [12, UFI2ActionLink, 1], [32772, null]]];
const ShimButton = [1, ShimButton_ComputeFunction, [15, 0, [8386, "a", ["role", 0, "button"], ["className", 0, 1, "click", 1, 2, "aria-pressed", 0, 3], 4], 1, [6, 1, [8386, "span", ["role", 0, "button"], ["className", 0, 2, "click", 1, 3, "aria-pressed", 0, 4], 5], [8386, "div", ["role", 0, "button"], ["className", 0, 2, "click", 1, 3, "aria-pressed", 0, 4], 5]]]];
...
const LoadingMarker = [1, LoadingMarker_ComputeFunction, [4, 0]];
...
const UFI2ShareActionLink = [1, UFI2ShareActionLink_ComputeFunction, [15, 0, [12, UFI2ActionLink, 1], 1, [12, UFI2ActionLink, 1]]];
