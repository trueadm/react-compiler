...
function UFI2ReactionsCount_ComputeFunction(feedback, feedbackTargetID) {
  ...
  return [[__cached__9["ajaxify"], void 0, cx("UFI2ReactionsCount/root"), "UFI2ReactionsCount/root", void 0, void 0, __cached__9["href"], void 0, void 0, [createVNode([66, "span", ["aria-hidden", 0, true, "className", 0, "UFI2ReactionsCount__countOnlySentence"]]), createVNode([66, "span", ["className", 0, "UFI2ReactionsCount__sentence foo UFI2ReactionsCount__sentenceWithSocialContext", "data-testid", 0, "UFI2ReactionsCount/sentenceWithSocialContext"]])], void 0, __cached__9["rel"], "button", void 0, void 0]];
}
...
function AbstractButton_ComputeFunction(ajaxify, aria_label, className, data_testid, depressed, disabled, href, image, imageRight, label, labelIsHidden, rel, role, tabIndex, type) {
  ...
  if (href) {
    ...
    return [0, [ajaxify, void 0, isDisabledButton ? true : undefined, aria_label, [image, labelIsHidden ? createVNode([1090, "span", ["className", 0, "accessible_elem"], [13, 0]], [label]) : label, imageRight], joinClasses(className, _className), data_testid, href, void 0, null, rel, void 0, disabled ? -1 : tabIndex, void 0]];
...
function UFI2TopReactions_ComputeFunction(className, feedback, feedbackTargetID) {
  ...
  function $UFI2TopReactions_renderLink(actorID: string, reactionEdge: Edge, reactionIndex: number): React.Node {
    ...
    return [[createVNode([11, AbstractButton, 0], [[__cached__5["ajaxify"], fbt["_"]("{i18nReactionCount} {i18nReactionName}", [fbt["_param"]("i18nReactionCount", i18nReactionCount), fbt["_param"]("i18nReactionName", i18nReactionName)], {
      ["hash_key"]: "1yBDpL"
    }), cx("UFI2TopReactions/link"), void 0, void 0, void 0, __cached__5["href"], void 0, void 0, [createVNode([11, UFIReactionIcon, 0], [[cx("UFI2TopReactions/icon"), "16"]])], void 0, __cached__5["rel"], "button", reactionsNotFocused && reactionIndex === 0 || currentReactionIsFocused ? 0 : -1, void 0]]), cx("UFI2TopReactions/tooltip"), null, {
      ["feedbackTargetID"]: feedbackTargetID,
      ["i18nReactionName"]: i18nReactionName,
      ["reactionType"]: reactionType
    }, "UFI2TopReactions/tooltip_" + reactionType, void 0, createVNode([2050, "div", [[11, UFI2ReactionIconTooltipTitle, 0], [3, 1]]], [[reactionEdge != null ? reactionEdge["node"] != null ? reactionEdge["node"]["localized_name"] : reactionEdge["node"] : reactionEdge], __cached__7]), -1]];
  }
  ...
  return [__cached__0, __cached__1, topThreeReactions["map"](function (edge: Edge, ii: number): React.Node {
    ...
    return createVNode([8, [11, LazyContentTooltip, 0], 0], [__cached__8], null);
  })];
}
...
function FeedStoryUFISummary_ComputeFunction(feedback, feedbackTargetID, onClickCommentsCount) {
  ...
  return [reaction_count != null ? reaction_count["count"] : reaction_count, [createVNode([11, UFI2TopReactions, 0], [[cx("fbFeedStoryUFI/topReactions"), feedback, feedbackTargetID]]), void 0], [createVNode([11, UFI2ReactionsCount, 0], [[feedback, feedbackTargetID]]), void 0]];
}
...
const UFIReactionsMenu = [32769, [32772, null]];
...
function UFI2ShareActionLink_ComputeFunction(className, feedback, feedbackTargetID, shareableConfig) {
  ...
  return [1, [(_ref9: {
    className: string
  }) => createVNode([1154, "span", ["className", 0, 0], [11, ShareLink, 1]], function (): React.Node {
    var __cached__17;
...
function XUISpinner_ComputeFunction(background, className, paused, showOnAsync, size) {
  ...
  return [[createVNode([194, "span", ["role", 0, "progressbar", "aria-busy", 0, "true", "aria-valuemin", 0, "0", "aria-valuemax", 0, "100"], ["className", 0, 0, "aria-valuetext", 0, 1]], [__cached__15, __cached__16])]];
}
...
function FeedStoryUFIRootRenderer_ComputeFunction(contextForFeedback, feedLocation, feedback, feedbackSource, feedbackTargetID, linkedCommentId, shareable_config) {
  ...
  return [[createVNode([2114, "div", ["className", 0, "fbFeedStoryUFI__summaryAndActionsContainer"], [[11, FeedStoryUFISummary, 0], [2114, "div", ["className", 0, "fbFeedStoryUFI__actionLinks"], [[11, UFI2ReactionActionLink, 1], [6, 2, [11, UFI2AnswerActionLink, 3], [11, UFI2CommentActionLink, 4]], [11, UFI2ShareActionLink, 5]]]]], [[feedback, feedbackTargetID, null], [void 0, feedback], feedback["is_q_and_a"], [void 0, feedback, null], [void 0, feedback, null], [void 0, feedback, feedbackTargetID, shareable_config]])]];
}
...
const UFI2RealtimeContainer = [1, UFI2RealtimeContainer_ComputeFunction, [11, OnVisible, 0]];
const ErrorBoundary = [1, ErrorBoundary_ComputeFunction, [13, 0]];
const UFI2ErrorBoundary = [1, UFI2ErrorBoundary_ComputeFunction, [11, ErrorBoundary, 0]];
...
const LazyContentTooltip = [1, LazyContentTooltip_ComputeFunction, [11, Tooltip, 0]];
...
const UFI2TopReactions = [1, UFI2TopReactions_ComputeFunction, [1218, "span", ["role", 0, "toolbar"], ["aria-label", 0, 0, "className", 0, 1], [15, 2]]];
const UFI2ReactionsCount = [1, UFI2ReactionsCount_ComputeFunction, [11, AbstractButton, 0]];
const FeedStoryUFISummary = [1, FeedStoryUFISummary_ComputeFunction, [1090, "div", ["className", 0, "fbFeedStoryUFI__feedbackSummary", "data-testid", 0, "fbFeedStoryUFI/feedbackSummary"], [6, 0, [2114, "div", ["className", 0, "fbFeedStoryUFI__reactionsSummary"], [[11, UFI2ErrorBoundary, 1], [11, UFI2ErrorBoundary, 2]]], [32772, null]]]];
...
const UFI2ReactionLink = [1, UFI2ReactionLink_ComputeFunction, [5, [[11, AWithFocusEvents, 0], [6, 1, [32772, null], [32772, null]]]]];
const UFI2ReactionActionLink = [1, UFI2ReactionActionLink_ComputeFunction, [6, 0, [11, UFI2ActionLink, 1], [32772, null]]];
...
const UFI2AnswerActionLink = [1, UFI2AnswerActionLink_ComputeFunction, [6, 0, [11, UFI2ActionLink, 1], [32772, null]]];
const UFI2CommentActionLink = [1, UFI2CommentActionLink_ComputeFunction, [6, 0, [11, UFI2ActionLink, 1], [32772, null]]];
const LoadingMarker = [1, LoadingMarker_ComputeFunction, [13, 0]];
const XUISpinner = [1, XUISpinner_ComputeFunction, [11, LoadingMarker, 0]];
const ShareLink = [1, ShareLink_ComputeFunction, [2242, "a", ["data-ft", 0, "{ &quot;tn&quot;: &quot;dummy&quot;, &quot;type&quot;: 25 }", "role", 0, "button", "tabindex", 0, 0], ["href", 0, 0, "className", 0, 1, "rel", 0, 2, "title", 0, 3], [[3, 4], [6, 5, [11, XUISpinner, 6], [32772, null]]]]];
const UFI2ShareActionLink = [1, UFI2ShareActionLink_ComputeFunction, [14, 0, [11, UFI2ActionLink, 1], 1, [11, UFI2ActionLink, 1]]];
const FeedStoryUFIRootRenderer = [1, FeedStoryUFIRootRenderer_ComputeFunction, [5, [[11, UFI2RealtimeContainer, 0], [32772, null]]]];
const Component = [0, ["feedLocation", "feedbackSource", "preloadedData", "queryVariables"], Component_ComputeFunction, [11, FeedStoryUFIRootRenderer, 0]];
